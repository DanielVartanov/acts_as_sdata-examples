...
Dir.glob(File.join(RAILS_ROOT, 'lib', 'sage', '**', '*.rb')).each { |filename| require filename }
Dir.glob(File.join(RAILS_ROOT, 'lib', 'last_obelus', 'active_record', '**', '*.rb')).each { |filename| require filename }
